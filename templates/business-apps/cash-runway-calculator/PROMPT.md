ONE-PAGE TOOL: Cash Runway Calculator
...
Opening cash, monthly operating cash in/out and optional dated one-time expenses. Calculate cumulative balances month by month; distinguish constant-burn estimate from detailed cash forecast. No investment advice.

ACCEPTANCE EXAMPLE
90000 cash with 25000 out and 10000 in per month gives 15000 net burn and six months. Nonpositive burn displays cash not declining under this scenario, not a fabricated depletion date.
...
VISUAL REFERENCE
Brand: RESERVE. Headline: Make time
for what’s next.. Composition: timeline. Palette: green. Primary action: Export cash forecast. Preview inputs: Available cash: $90,000; Monthly cash out: $25,000; Monthly cash in: $10,000. Preview result: 6 months — ESTIMATED CASH RUNWAY.
